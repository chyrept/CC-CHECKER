		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>Spam✘</strong></h4>

					<textarea rows="12" class="form-control text-center form-checker mb-2" placeholder="PUT _YOUR_CARDS_HERE"></textarea>
					<textarea rows="1" class="form-control text-center" id="skc" placeholder="sk_live_xxxxxx  Spam✘"></textarea></br>
					<textarea rows="1" class="form-control text-center" style="width:55%; float: left ;"  id="tg" placeholder="Telegram ID"></textarea>
					<textarea rows="1"class="form-control text-center" style="width: 45%; float: right margin-bottom: 5px;" id="amo" placeholder="Custom Amount"></textarea></br>
...
if(total > 10000000){
  Swal.fire({title: 'YOU CAN NOT PERFORM THAT ACTION: REDUCE NUMBER OF CARDS TO <4999', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 1000});
  return false;
}
...
var callBack = $.ajax({
    url: 'api.php?lista=' + data + '&skc=' + skc + '&tg=' + tg + '&amo=' + amo,
